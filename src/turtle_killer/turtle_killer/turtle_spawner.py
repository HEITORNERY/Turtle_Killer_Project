...
from turtle_msgs.msg import Turtle
from turtle_msgs.msg import TurtleArray
from turtle_srv.srv import CatchTurtle
...
class TurtleSpawner(Node):
    def __init__(self):
        ...
        self.spawn_turtle_timer_ = self.create_timer(1.0/self.get_parameter("spawn_frequency").value, self.spawn_new_turtle)
